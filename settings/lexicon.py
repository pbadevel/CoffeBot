...
Система лояльности "Стакан за друга" представляет собой ...
...
<span class="tg-spoiler">P.s. Собери 10 стаканов и получишь 10 Бабл ти в подарок! 🎁</span>
'''
...
NOT_BARISTA_TEXT = '''
Вы <b>не являетесь</b> баристой этой Бабл тийни, если это не так - свяжитесь с поддержкой:
