...
async def process_del_admin(callback: types.CallbackQuery, state: FSMContext) -> None:
    ...
    for user in list_users:
        list_personal.append([user.user_id, user.username if user.username else user.fullname])
...
async def process_back_del_admin(callback: types.CallbackQuery, state: FSMContext) -> None:
    ...
    list_personal = []
    for user in list_users:
        list_personal.append([user.user_id, user.username if user.fullname else user.fullname])
